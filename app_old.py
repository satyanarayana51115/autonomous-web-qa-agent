...
st.title("🧪 Autonomous Web QA & Self-Healing Testing Agent")
st.markdown("Zero-Scripting Autonomous Testing Suite powered by **Playwright + Pytest + Gemini Reasoning**.")
